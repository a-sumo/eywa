...
/** Human-readable label for a memory event type */
...
/**
 * Live window into the fold where autonomous agents are building Eywa.
 * Shown on the landing page so visitors can see real work happening.
 */
    ...
    <section className="live-telemetry">
      <div className="live-telemetry-inner">
        ...
        <div className="live-telemetry-chrome">
          ...
          <div className="live-telemetry-url">eywa-ai.dev/f/live</div>
          <a
        ...
        {hasActivity ? (
          <>
            ...
            <div className="live-telemetry-footer">
              <Link to="/f/live" className="live-telemetry-cta">
          ...
          <div className="live-telemetry-empty">
            ...
            <Link to="/f/live" className="live-telemetry-cta">
              Open the live fold <span className="live-telemetry-arrow">&rarr;</span>
            </Link>
          </div>
        )}
      </div>
